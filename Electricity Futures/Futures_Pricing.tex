...
Here $\E^P$ is the expectation operator, under the historical measure $P$, with information up until time $t$ and $S(T)$ is the spot price at time $T$\\
 \quad \hyperlink{BLmodel}{\beamergotobutton{Bessembinder-Lemon Model}}\\
...
\frame{
	...
	\begin{itemize}
		...
		\item At short end: positive MPR due to skewness in spot prices (Bessembinder \& Lemon (2002))
...
\frame{
	...
	\begin{itemize}
		...
		\end{itemize}
	\end{itemize}\quad \hyperlink{MPR}{\beamergotobutton{Return}}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
